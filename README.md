...
```
╔══════════════════════════════════════════════════════════════════════╗
║  Versatile engineer who builds across the full stack —              ║
║  from React UIs and REST APIs to embedded firmware,                 ║
║  IoT systems, mobile apps, and intelligent machines.                ║
...
### Frontend & Mobile
[![Skills](https://skillicons.dev/icons?i=react,nextjs,flutter,tailwind,scss,vite,webpack,materialui&theme=dark)](https://skillicons.dev)
...
![Axum](https://img.shields.io/badge/-Axum-F97316?style=flat-square&logo=rust&logoColor=white)
...
![Cargo](https://img.shields.io/badge/-Cargo-F97316?style=flat-square&logo=rust&logoColor=white)
...
![RPi](https://img.shields.io/badge/-Raspberry%20Pi-A22846?style=flat-square&logo=raspberrypi&logoColor=white)
...
![TFLite](https://img.shields.io/badge/-TFLite%20Micro-FF6F00?style=flat-square&logo=tensorflow&logoColor=white)
...
![Proteus](https://img.shields.io/badge/-Proteus-1B4F72?style=flat-square)
...
[![MIT](https://img.shields.io/badge/MIT-0057FF?style=flat-square)]()
...
[![Repo](https://img.shields.io/badge/→%20View%20Repo-0a0d14?style=for-the-badge&logo=github&logoColor=white)](https://github.com/cybergenii/ion)
...
[![npm](https://img.shields.io/badge/npm-CB3837?style=flat-square&logo=npm&logoColor=white)](https://www.npmjs.com/package/expressbolt)
[![Status](https://img.shields.io/badge/Active-10B981?style=flat-square)]()
...
[![Repo](https://img.shields.io/badge/→%20View%20Repo-0a0d14?style=for-the-badge&logo=github&logoColor=white)](https://github.com/cybergenii/expressbolt)
...
[![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white)]()
[![npm](https://img.shields.io/badge/npm-CB3837?style=flat-square&logo=npm&logoColor=white)](https://www.npmjs.com/package/andrea-table)
[![Status](https://img.shields.io/badge/Active-10B981?style=flat-square)]()

> *Config-in, production table out.*

Pass one config object — get a fully wired React data table with API integration, multi-column sort, filter, pagination, CRUD actions, custom cell renderers, theming, and auto-refresh.
...
[![Repo](https://img.shields.io/badge/→%20View%20Repo-0a0d14?style=for-the-badge&logo=github&logoColor=white)](https://github.com/cybergenii/andrea-table)
...
[![Dart](https://img.shields.io/badge/Dart-0175C2?style=flat-square&logo=dart&logoColor=white)]()
[![pub.dev](https://img.shields.io/badge/pub.dev-0175C2?style=flat-square&logo=dart&logoColor=white)](https://pub.dev/packages/flutter_wireless)
[![Status](https://img.shields.io/badge/Active-10B981?style=flat-square)]()
...
[![Repo](https://img.shields.io/badge/→%20View%20Repo-0a0d14?style=for-the-badge&logo=github&logoColor=white)](https://github.com/cybergenii/flutter_wireless)
...
**Open to collaborations · Freelance · Full-time · Open Source**
